  ...
  return (
    <>
      ...
      <div className="radial-container">
        {isOpen && <div className="radial-menu" role="menu" aria-label="Game options"><button className="radial-action radial-action-restart" onClick={onRestart} role="menuitem" aria-label="Restart"><RotateCcw size={20} /></button><button className="radial-action radial-action-config" onClick={onConfig} role="menuitem" aria-label="Configuration"><Settings2 size={20} /></button><button className="radial-action radial-action-about" onClick={onAbout} role="menuitem" aria-label="About"><Info size={20} /></button></div>}
