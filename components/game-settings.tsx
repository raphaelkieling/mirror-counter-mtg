...
export function GameSettings({ startLife, historyDelay, closeRadialOnDialog, showTime, darkMode, showFloatingNumbers, holdIncrement, keepAliveScreen, onStartLifeChange, onHistoryDelayChange, onCloseRadialOnDialogChange, onShowTimeChange, onDarkModeChange, onShowFloatingNumbersChange, onHoldIncrementChange, onKeepAliveScreenChange }: { startLife: number; historyDelay: number; closeRadialOnDialog: boolean; showTime: boolean; darkMode: boolean; showFloatingNumbers: boolean; holdIncrement: number; keepAliveScreen: boolean; onStartLifeChange: (value: number) => void; onHistoryDelayChange: (value: number) => void; onCloseRadialOnDialogChange: (value: boolean) => void; onShowTimeChange: (value: boolean) => void; onDarkModeChange: (value: boolean) => void; onShowFloatingNumbersChange: (value: boolean) => void; onHoldIncrementChange: (value: number) => void; onKeepAliveScreenChange: (value: boolean) => void }) {
  ...
  return (
    <div className="settings-content">
      ...
      <div className="toggle-row" style={{ justifyContent: 'space-between' }}><span className="toggle-label">Keep screen on</span><button className="checkbox-toggle" onClick={() => onKeepAliveScreenChange(!keepAliveScreen)} aria-label="Toggle keep screen on" style={{ borderColor: keepAliveScreen ? '#4652f5' : '#d9d7df', backgroundColor: keepAliveScreen ? '#4652f5' : 'transparent' }}>{keepAliveScreen && <Check size={16} color="#fff" strokeWidth={3} />}</button></div>
