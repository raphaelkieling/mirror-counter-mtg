...
export function GameSettings({ startLife, historyDelay, closeRadialOnDialog, showTime, darkMode, showPlayerName, showFloatingNumbers, onStartLifeChange, onHistoryDelayChange, onCloseRadialOnDialogChange, onShowTimeChange, onDarkModeChange, onShowPlayerNameChange, onShowFloatingNumbersChange }: { startLife: number; historyDelay: number; closeRadialOnDialog: boolean; showTime: boolean; darkMode: boolean; showPlayerName: boolean; showFloatingNumbers: boolean; onStartLifeChange: (value: number) => void; onHistoryDelayChange: (value: number) => void; onCloseRadialOnDialogChange: (value: boolean) => void; onShowTimeChange: (value: boolean) => void; onDarkModeChange: (value: boolean) => void; onShowPlayerNameChange: (value: boolean) => void; onShowFloatingNumbersChange: (value: boolean) => void }) {
