...
export function GameSettings({ startLife, historyDelay, closeRadialOnDialog, onStartLifeChange, onHistoryDelayChange, onCloseRadialOnDialogChange }: { startLife: number; historyDelay: number; closeRadialOnDialog: boolean; onStartLifeChange: (value: number) => void; onHistoryDelayChange: (value: number) => void; onCloseRadialOnDialogChange: (value: boolean) => void }) {
  return (
    <>
