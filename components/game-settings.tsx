...
export function GameSettings({ startLife, historyDelay, closeRadialOnDialog, showTime, darkMode, showPlayerName, showFloatingNumbers, holdIncrement, onStartLifeChange, onHistoryDelayChange, onCloseRadialOnDialogChange, onShowTimeChange, onDarkModeChange, onShowPlayerNameChange, onShowFloatingNumbersChange, onHoldIncrementChange }: { startLife: number; historyDelay: number; closeRadialOnDialog: boolean; showTime: boolean; darkMode: boolean; showPlayerName: boolean; showFloatingNumbers: boolean; holdIncrement: number; onStartLifeChange: (value: number) => void; onHistoryDelayChange: (value: number) => void; onCloseRadialOnDialogChange: (value: boolean) => void; onShowTimeChange: (value: boolean) => void; onDarkModeChange: (value: boolean) => void; onShowPlayerNameChange: (value: boolean) => void; onShowFloatingNumbersChange: (value: boolean) => void; onHoldIncrementChange: (value: number) => void }) {
  ...
  return (
    <div className="settings-content">
      ...
      <div className="toggle-row" style={{ justifyContent: 'space-between' }}><span className="toggle-label">Show player name</span><button className="checkbox-toggle" onClick={() => onShowPlayerNameChange(!showPlayerName)} aria-label="Toggle show player name" style={{ borderColor: showPlayerName ? '#4652f5' : '#d9d7df', backgroundColor: showPlayerName ? '#4652f5' : 'transparent' }}>{showPlayerName && <Check size={16} color="#fff" strokeWidth={3} />}</button></div>
